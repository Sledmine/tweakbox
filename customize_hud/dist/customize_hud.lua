...
---@field powerAmount number Position amount of this device machine
---@field powerChange number Power change of this device machine
---@field positionAmount number Position amount of this device machine
...
local deviceMachineStructure = extendStructure(objectStructure, {
    powerAmount = {type = "float", offset = 0x1F8},
    powerChange = {type = "float", offset = 0x200},
    positionAmount = {type = "float", offset = 0x208},
